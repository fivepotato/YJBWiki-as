            ...
            for(let card of cards){
                ...
                Promise.all([
                    ...
                    if(!info.passive_skill_2[0])line13 = "||";
                        ...
                        const line13_1 = `${info.passive_skill_2[0].trigger_type}|${info.passive_skill_2.skill_condition_master_id1}|${info.passive_skill_2.skill_condition_master_id2?info.passive_skill_2.skill_condition_master_id2:new String()}|${info.passive_skill_2.trigger_probability}|${info.skill_passive_2[0].skill.skill_target_master_id1}|${info.skill_passive_2[0].skill_effect_1.effect_type}|${info.skill_passive_2[0].skill_effect_1.effect_type}|${info.skill_passive_2[0].skill_effect_1.effect_value}|${info.skill_passive_2[0].skill_effect_1.calc_type}|${info.skill_passive_2[0].skill_effect_1.finish_type}|${info.skill_passive_2[0].skill_effect_1.finish_value}`;
